        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-neon-green/5 border-neon-green/20">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-neon-green-dark uppercase tracking-wider flex items-center gap-2">
          ...
          <Card className="bg-white border-slate-100">
            ...
            <CardContent>
              <div className="space-y-1 text-sm text-slate-600">
                ...
                <div className="flex justify-between">
                  <span>Leads:</span>
                  <span className="font-bold">{benchmarks.leads_min}</span>
                </div>
              </div>
            </CardContent>
          </Card>
